<template>
	<div>
		<div class="released" :style="{'left':left+'px','top':top+'px'}" @click.prevent.stop="released" @mousedown.prevent.stop="mousedown" @mouseup.prevent.stop="mouseup" @mouseout.prevent.stop="mouseup" @mousemove="mousemove">
